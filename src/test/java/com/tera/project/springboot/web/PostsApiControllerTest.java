...
public class PostsApiControllerTest {
    ...
    public void Posts_수정된다() throws Exception {
        ...
        String modifyTitle = "title2";
        String modifyContent = "content2";
        ...
        List<Posts> all = postsRepository.findAll();
        assertThat(all.get(0).getTitle()).isEqualTo(modifyTitle);
        assertThat(all.get(0).getContent()).isEqualTo(modifyContent);
    }
}
